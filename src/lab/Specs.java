...
public class Specs {
    /**
     * ฟังก์ชั่นนี้ทำการค้นหาตำแหน่งแรกที่เจอ key ในอาเรย์ arr
     * @param arr อาเรย์ที่ถูกค้นหา
     * @param key ค่าที่ค้นหา
     * @return ตำแหน่งที่ถูกค้นหา ถ้าค้นหาไม่เจอจะส่ง-1
    ...
    /**
     * 
     * @param radius รัศมีวงกลมต้องไม่เป็นค่าลบ
     * @return  พื้นที่วงกลม
     ...
     * @return ข้อความความที่ถูกตัดและแปลงเป็นตัวพิมพ์เล็ก
     */
